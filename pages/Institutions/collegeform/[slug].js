...
function CollegeForm({ data, query }) {
    ...
    const [college, setCollege] = useState(data.college_id);
    ...
    useEffect(() => {
        // const collegeData = router.query
        // setCollege(collegeData.college_id)
    ...
    useEffect(() => {
        const getColleges = async () => {
            try {
                let response
                if (college) {
                    response = await apiCall(`get_college_by_id.php?collegeid=${college}`, "get")
                        ...
                        <div className="col-lg-12 p-0">
                            <div className='shadow-lg'>
                                <form noValidate className='row d-flex justify-content-center ' >
                                    ...
                                    <div data-aos="zoom-in-right" className="input-field col-md-8 col-10 my-3">
