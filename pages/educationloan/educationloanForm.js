...
function EducationloanForm() {
    ...
    const loanData = router.query.id
    ...
    useEffect(() => {
        const PostData = async () => {
            try {
                const result = await apiCall("add_loan_enquiry.php", "post",formValues)
    ...
    }, [formErrors, formValues, initialValues, isSubmitting])
 ...
 data-aos="zoom-in-right"data-aos-easing="ease-in-back" data-aos-delay="500" data-aos-offset="0"
>
                <h3 className='heading'> Loan Enquiry Form</h3>
                <div className='row my-md-5 my-3'>
                    ...
                    <div className="input-field row mt-4" >
