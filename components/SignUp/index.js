...
import { getItem, removeItem, setItem } from '../../utils/utilsFunctions';
export default function SignUp({ popupClose }) {
  ...
  useEffect(() => {
    const PostData = async () => {
      ...
      try {
        const url = "https://getyourcollege.in/gyc_admin/api/login_student.php"
        ...
        if (result.data.success && result.data.user) {
          await setItem("GYC_login_user_data", JSON.stringify(result.data.user));
