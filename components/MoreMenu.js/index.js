...
export default function MoreMenu({ ugCourses, pgCourses, Coaching, ugExams, pgExams }) {
      ...
      return (
          <div ref={wrapperRef}>
            {/* <Button >
                ...
                <svg aria-describedby={id} onClick={handleClick} className="toggle_bar" xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" viewBox="0 0 16 16" fill="#121268"><path d="M12 12h4v4h-4zm0-6h4v4h-4zM6 0h4v4H6zm10 0v4h-4V0zM6 6h4v4H6zM0 6h4v4H0zm0 6h4v4H0zm6 0h4v4H6zM0 0h4v4H0z"></path></svg>
            <Popover
                id={id}
                open={open}
                anchorEl={anchorEl}
                ...
                >
                <Container className='p-3 Burger_Popup_container' data-aos="fade-left">
                    <div className='row '>
                        <div className='col-md-6 inner_tab hideTab'>
                        ...
                        <div className='col-md-6 inner_tab hideTab'>
                            <div className='inner_tab_Sec'>
                                ...
                                <Link href="/Institutions">College Explore</Link>
                            </div>
                        </div>
                        <div className='col-md-6 inner_tab hideTab'>
                            <div className='inner_tab_Sec'>
                        ...
                        {/* <div className='col-md-6 inner_tab hideTab'>x
                            <div className='inner_tab_Sec'>
                            <i className="ri-questionnaire-fill"></i>
                                <Link href="/">Need Counselling</Link>
                                we need to render modal popup here
                            </div>
                        </div> */}
                        <div className='col-md-6 inner_tab hideTab'>
                            <div className='inner_tab_Sec'>
                        ...
                        <div className='col-md-6 inner_tab hideTab'>
                            ...
                            <i className="ri-hand-heart-fill"></i>
                                <Link href="/about"> Scholarhip</Link> 
                            </div>
                        </div>
                        <div className='col-md-6 inner_tab hideTab'>
                            <div className='inner_tab_Sec'>
                        ...
                        <div className='col-md-6 inner_tab'>
                            <div className='inner_tab_Sec'>
                                ...
                                <a href='https://getyourcollege.in/blog/all-blogs/' rel="noopener noreferrer" target="_blank">Blogs</a>
                            </div>
                        </div>
                        <div className='col-md-6 inner_tab'>
                            <div className='inner_tab_Sec'>
